    ...
    <div className="bg-[#0a0a0a] text-[#e8e4dc] min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-8 md:px-16 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          >
            ...
            <span className="text-xs text-white/40 tracking-[3px] uppercase">
          ...
          >
            ...
            <span className="block text-[#f5a623]">Full Stack Dev</span>
            <span className="block text-white/30">→ AI Engineer.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            custom={2}
          >
            I build full-stack web applications using React, Tailwind, and
            MongoDB, with a focus on clean UI and scalable backend logic.
            Currently sharpening my DSA skills and diving deep into AI/ML
            engineering — my goal is to build intelligent systems that solve
            real-world problems.
          </motion.p>
      ...
      <section className="px-8 md:px-16 py-32 border-t border-white/5">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-start">
          ...
          >
            <span className="text-xs tracking-[4px] text-[#f5a623]/60 uppercase mb-4 block">
              01 — About
            </span>
            <h2
            ...
            <p className="text-white/50 leading-relaxed mb-4">
             I'm a self-taught developer from Kerala, India. What started as 
curiosity about how websites work has grown into building full-stack 
applications with React, Tailwind, and MongoDB — and now I'm pushing 
further into DSA, system design, and AI engineering.
            </p>
            <p className="text-white/50 leading-relaxed mb-4">
  My core stack is{" "}
  ...
  . I'm actively building with TypeScript, Docker, and Next.js — 
  while sharpening my DSA fundamentals and moving toward 
  AI engineering.
</p>
<p className="text-white/50 leading-relaxed">
  I'm looking for a role where I can write meaningful code, 
  get sharp feedback, and grow into an engineer who builds 
  intelligent systems — not just websites.
</p>
          </motion.div>
          ...
          >
            {[
              ...
              { area: "Backend", items: "Node.js · Express · MongoDB" },
              {
                area: "DevOps",
                items:
                  "Git · GitHub · Docker(In Progress) · CI/CD (In Progress)",
              },
              { area: "Design", items: "Figma · UX Principles · Responsive" },
              { area: "Learning", items: "TypeScript · Next.js · Rust · AI" },
              {
                area: "Soft Skills",
                items: "Self-driven · Collaborative · Fast learner",
              },
            ].map(({ area, items }) => (
              <div
                key={area}
                className="border border-white/5 rounded-lg p-4 hover:border-[#f5a623]/30 transition-colors duration-300 group"
              >
                <div
                  className="text-[#f5a623] text-xs font-bold mb-2 tracking-wider uppercase"
                  style={{ fontFamily: "Syne, sans-serif" }}
                >
                  {area}
                </div>
                <div className="text-white/35 text-xs leading-relaxed group-hover:text-white/50 transition-colors duration-300">
                  {items}
                </div>
              </div>
            ))}
            ...
            {[
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <span
                    className="text-[#f5a623]/30 text-xs font-bold"
                    style={{ fontFamily: "Syne, sans-serif" }}
                  >
                    {n}
                  </span>
                  <span className="text-[10px] text-white/25 border border-white/10 rounded px-2 py-0.5">
                    {tag}
                  </span>
                </div>
                <h3
